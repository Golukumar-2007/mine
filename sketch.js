...
function preload() {
  ...
  up1Image = loadImage("assets/up1.png")
...
function setup() {
  ...
  //creating up button 
 // up1 = createSprite(windowWidth-1150,windowHeight-200,windowWidth-150,windowHeight -100)
 // up1.addImage(up1Image)
 // up1.scale = 0.1
 // if (up1.mousePressed()){ ///sudshgisguabnigfeyajtmvuif,ooo t,oi. ybyujmvccnnnnnnnnnnnnnnnnnnnnnvvvvvvvvvvvvvvvyyyyyyyyyyy
   // move();
  //}

  up1 = createImg('assets/up1.png');
  up1.position(windowWidth-1250,windowHeight- 250);
 up1.size(windowWidth -1170,windowHeight-500);
 up1.mouseClicked(move);

 up2 = createImg('assets/up2.png');
 up2.position(windowWidth-1250,windowHeight- 100);
up2.size(windowWidth -1170,windowHeight-500);
up2.mouseClicked(move2);

fb = createImg('assets/fb.png');
fb.position(windowWidth-200,windowHeight- 200);
fb.size(windowWidth -1170,windowHeight-500);
fb.mouseClicked(fire);


  //creating the plane sprite
  plane = createSprite(displayWidth - 1050, displayHeight - 400, 50, 50);
